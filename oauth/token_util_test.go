...
func (suite OauthUtilsTestSuite) TestShouldReturnIdTokenForGivenValidJWETokenInGinContext() {
	...
	testServer := httptest.NewServer(http.HandlerFunc(func(res http.ResponseWriter, req *http.Request) {
		http.SetCookie(res, &http.Cookie{
			Name:  "id_token",
			Value: "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOiI2MjA5NDNhMi1iYTUxLTQyMzEtODViMC1jYzExOWMxMDg0MGEiLCJ1c2VybmFtZSI6ImR1bW15LXVzZXIiLCJlbWFpbCI6ImR1bW15QGdtYWlsLmNvbSIsInN1YmplY3QiOiI2MjA5NDNhMi1iYTUxLTQyMzEtODViMC1jYzExOWMxMDg0MGEiLCJhdF9oYXNoIjoiejRyVmVWOUlEVzRtUUJnazgwRVBXZyJ9.u2OhPnr6UDFgZL7ggbbDv_wN7izPR7-yj1BQFzyxQVU",
		})
		res.WriteHeader(200)
		_, _ = res.Write([]byte(""))
	}))
